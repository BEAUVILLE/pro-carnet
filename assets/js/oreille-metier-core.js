...
(function () {
  ...
  var VERSION = "oreille-metier-core-20260524-pay-first";
  ...
  function setNotes(config, notes) {
    ...
    try {
      ...
      /* Local storage peut être bloqué. On ne casse jamais la page. */
    }
  }
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (autoTarget) {
      mount({
        ...
        title: autoTarget.getAttribute("data-title") || "Oreille Métier PAY"
      });
    }
  });
})();
